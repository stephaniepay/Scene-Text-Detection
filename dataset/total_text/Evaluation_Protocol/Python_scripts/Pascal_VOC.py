...
input_dir = 'output/tt-5523'  #detection directory goes here
gt_dir = '/data/total-text/Images/gt' #gt directory goes here
fid_path = 'Python_VOC_result_last_check.txt' #output text file directory goes here
