...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--net', default='vgg', type=str, choices=['vgg', 'resnet', 'DenseNet121'], help='Network architecture')
        ...
        self.parser.add_argument('--max_epoch', default=201, type=int, help='Max epochs')
        self.parser.add_argument('--start_epoch', default=0, type=int, help='Start epochs')
